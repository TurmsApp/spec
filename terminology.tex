\blockquote[\fullcite{rfc2119}]{
    \begin{enumerate}
        \item MUST   This word, or the terms "REQUIRED" or "SHALL", mean that 
...
These words are to be interpreted as described in BCP 14 \cite{rfc8174} when
they appear in all capitals.

We will use \enquote{P2P} to mean \enquote{point-to-point, more generally
peer-to-peer}.