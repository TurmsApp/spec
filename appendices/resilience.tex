...
\begin{abstract}
    Cette démonstration, par la théorie des graphes, permet de comparer la
    résilience des réseaux pairs-à-pairs face aux réseaux centralisés, en
    partant de certains postulats empiriques.
\end{abstract}
